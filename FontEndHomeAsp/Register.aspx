...
<head lang="en">
    ...
    <style >
        .res-banner1 {
            width:100%;height:470px; background:#f2f2f2;
        }
    </style>
    ...
    <script type="text/javascript">
        ...
        function send_sms(val){
            ...
            //alert(phone);
            $.ajax({
                url: '/Ajax/SendSMS.ashx?phone_number=' + phone,
                type: 'GET',
                async: false,
                cache: false,
                contentType: false,
...
<div class="login-boxtitle">
    <a href="Register.aspx">
        <img alt="" src="style/images/logo1.png" /></a>
</div>
<div class="res-banner1">
    <div class="res-main">
        <div class="login-banner-bg">
            <span></span>
            <img src="home/images/big2.jpg" /></div>
                    ...
                    <div class="am-tabs-bd">
                        ...
                        <div class="am-tab-panel">
                            <div class="user-phone">
                                ...
                                <input type="text" name="userName" id="userName" placeholder="请输入昵称" runat="server" />
                            </div>
                            <div class="user-phone">
                                <label for="phone">
...
<div class="footer ">
    <div class="footer-bd ">
        <p>
            <a href="About.aspx">关于前端之家</a> <em>© 2017-2018 前端之家 版权所有</em>
        </p>
    </div>
</div>
</body>
